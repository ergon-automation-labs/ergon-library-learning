# Getting Started with bot_army_learning

This guide walks you through setting up Learning Bot for local development.
...
DATABASE_NAME=bot_army_learning_dev
```
...
This creates a release named `learning_bot` that is deployed to `/opt/ergon/releases/learning_bot/` on the server.
...
3. Extracts and deploys to `/opt/ergon/releases/learning_bot/`
